                ...
                <div class="ibox-content">
                                        ...
                                        <div class="col-lg-3">
                                            <ul class="stat-list">
                                                ...
                                                <li>
                                                    ...
                                                    <div class="progress progress-mini">
                                                        <div style="width: <?= $db->count_rows_active($con, 'internal_leads'); ?>%;" class="progress-bar"></div>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="progress progress-mini">
                                                        <div style="width: <?= $db->count_rows_complete($con, 'internal_leads') ?>%;" class="progress-bar"></div>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="col-lg-6">
                                <?php if ($role == 'admin') { ?><a href="web_requests?verification_status=0"><?php } ?>
                                    <div class="kwidget navy-bg p-lg text-center" style="border-radius:5px;" >
                                        <div style="color: white;">
                                            <div class="m-b-md" style="padding-top: 20px;padding-bottom: 20px;">
                                                <i class="fa fa fa-4x"></i>
                                                <h1 class="m-xs"><?php
                                                    echo $db->count_rows_new_web($con, 'web_posts');
                                                    ?></h1>
                                                <h3 class="font-bold no-margins">
                                                    New <br />Requests 
                                                </h3>
                            ...
                            <div class="col-lg-6">
                                <?php if ($role == 'admin') { ?><a href="web_requests?verification_status=1"><?php } ?>
                                    <div class="kwidget  blue-bg p-lg text-center" style="border-radius:5px;" >
                                        <div style="color: white;">
                                            <div class="m-b-md"style="padding-top: 20px;padding-bottom: 20px;">
                                                <i class="fa fa fa-4x"></i>
                                                <h1 class="m-xs"><?php
                                                    echo $db->count_rows_verified_web($con, 'web_posts');
                                                    ?></h1>
                                                <h3 class="font-bold no-margins">
                                                    Verified <br />Requests
                                                </h3>
                                                <small>Active</small>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="kwidget navy-bg p-lg text-center" style="background-color: #275d3b;border-radius:5px;">
                                                                    <div style="color: white;"> 
                                                                        <div class="m-b-md"style="padding-top: 20px;padding-bottom: 20px;">
                                                                            <i class="fa fa fa-4x"></i>
                                                                            <h1 class="m-xs"><?php
                            echo $db->count_rows_complete_web($con, 'web_posts');
                            ?></h1>
                                                                            <h3 class="font-bold no-margins">
                                                                                Completed <br />Requests
                                                                            </h3>
                                                                            <small>All Completed Sales</small>
                                                                        </div>
                                                                    </div>
...
<script>
    $(document).ready(function () {
        ...
        var data2 = [
<?php
$queryChart1 = mysqli_query($con, "SELECT * FROM `internal_leads` WHERE  NOT `progress`= '0'  AND NOT `progress` = 'New' ORDER BY `id`");
while ($rowChart1 = mysqli_fetch_assoc($queryChart1)) {
    echo '[gd(' . $db->getFromDateTime($rowChart1["timestamp"]) . '), ' . $rowChart1["progress"] . '],';
}
?>
//            [gd(2022, 4, 1), 1],
//            [gd(2022, 4, 2), 6],
...
//            [gd(2022, 4, 31), 25]
        ...
        var data3 = [
<?php
$queryChart2 = mysqli_query($con, "SELECT * FROM `internal_leads` ORDER BY `timestamp`");
while ($rowChart2 = mysqli_fetch_assoc($queryChart2)) {
    echo '[gd(' . $db->getFromDateTime($rowChart2["timestamp"]) . '), 1000],';
}
?>
//            [gd(2022, 4, 1), 800],
//            [gd(2022, 4, 2), 500],
